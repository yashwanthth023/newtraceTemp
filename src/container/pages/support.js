                    ...
                    <Col lg={8} xs={24}>
                      <div className="sDash-support-link-item">
                        <div className="sDash-support-link-item__icon primary">
                          <img src={require(`../../static/img/icon/idea.svg`).default} alt="" />
                        </div>
                    ...
                    <Col lg={8} xs={24}>
                      <div className="sDash-support-link-item">
                        <div className="sDash-support-link-item__icon info">
                          <img src={require(`../../static/img/icon/chat.svg`).default} alt="" />
                        </div>
                    ...
                    <Col lg={8} xs={24}>
                      <div className="sDash-support-link-item">
                        <div className="sDash-support-link-item__icon success">
                          <img src={require(`../../static/img/icon/documentation.svg`).default} alt="" />
                        </div>
